...
1. После нажатия на кнопку твиттера появляется окошко где мы 1)Выбираем использовать данные которые в настройках (разрешение для программы должно быть включено) 
...
+ добавляет новые твиты, свайп по таблице вниз обновляет ленту.
